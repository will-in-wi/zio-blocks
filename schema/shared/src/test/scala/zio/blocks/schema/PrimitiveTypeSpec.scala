  ...
  def spec: Spec[TestEnvironment with Scope, Any] = suite("PrimitiveTypeSpec")(
    ...
    suite("PrimitiveType.DayOfWeek")(
      test("has consistent toDynamicValue and fromDynamicValue") {
        ...
        assert(tpe.toDynamicValue(java.time.DayOfWeek.MONDAY))(
          equalTo(DynamicValue.Primitive(PrimitiveValue.DayOfWeek(java.time.DayOfWeek.MONDAY)))
        ) &&
        assert(tpe.fromDynamicValue(DynamicValue.Primitive(PrimitiveValue.DayOfWeek(java.time.DayOfWeek.MONDAY))))(
          isRight(equalTo(java.time.DayOfWeek.MONDAY))
        ) &&
        assert(tpe.fromDynamicValue(DynamicValue.Primitive(PrimitiveValue.Long(1L))))(
